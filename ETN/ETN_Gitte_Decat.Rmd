...
I tried creating the adapter file based on the tutorial from biocypher to have a script that works. I i try to run the adapter file based on the Crossbar files it does not work. therefore i went back to an more easier example to take as a base. 
