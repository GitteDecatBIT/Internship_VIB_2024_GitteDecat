...
class IRefIndexAdapter:
    ...
    def get_nodes(self, rename_selected_fields: Union[None, list[str]] = None):
        ...
        # Create Protein object for the current node_id with corresponding taxon
                ...
                self.nodes.append(Protein(node_id=node_id, taxon=taxon,pubmed_id= pubmed_id, fields=self.node_fields))
...
class Protein(Node):
    ...
    def __init__(self, node_id:str, taxon:str, pubmed_id: str, fields: Optional[list] = None):
        self.fields = fields
        self.id = node_id
        self.label = "uniprot_protein"
        self.properties = self._generate_properties(taxon, pubmed_id)
        self.taxon = taxon
        self.pubmed_id =pubmed_id
        

    def _generate_properties(self,taxon,pubmed_id):
        properties = {}
